...
```{r setup-tibble}
team_data <- tibble(
  name = c("Peter Rabbit", "Ethan", "Greg", 
           "Barry", "Beth"),
  github_username = c("mcgregors-garden", "Ethan1", "Greg2", 
                      "Barry3", "Beth4"), 
  colour = c("powderblue", "cornsilk4", "navajowhite4", 
             "gold3", "grey50"),
  hobby = c("Hopping", "Cycling", "Running", 
            "Swimming", "skiing"),
...
p1 + labs(x = "Github Username", 
          y = "Favourite Number",
          title = "Team Members Favourite Numbers")
```
